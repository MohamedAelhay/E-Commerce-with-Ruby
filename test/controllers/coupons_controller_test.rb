...
class CouponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post coupons_url, params: { coupon: { code: @coupon.code, discount_amount: @coupon.discount_amount, discount_type: @coupon.discount_type, expiration_date: @coupon.expiration_date, usage_number: @coupon.usage_number } }
    end
  ...
  test "should update coupon" do
    patch coupon_url(@coupon), params: { coupon: { code: @coupon.code, discount_amount: @coupon.discount_amount, discount_type: @coupon.discount_type, expiration_date: @coupon.expiration_date, usage_number: @coupon.usage_number } }
