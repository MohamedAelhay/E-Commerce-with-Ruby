...
class UserCouponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_coupon" do
    assert_difference('UserCoupon.count') do
      post user_coupons_url, params: { user_coupon: { coupon_id: @user_coupon.coupon_id, user_id: @user_coupon.user_id } }
    end
  ...
  test "should update user_coupon" do
    patch user_coupon_url(@user_coupon), params: { user_coupon: { coupon_id: @user_coupon.coupon_id, user_id: @user_coupon.user_id } }
